...
# 1. Uncertainty calculation logic (to be added)
uncertainty_functions = [
    "# \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\n",
    "# LAPLACE UNCERTAINTY ESTIMATION (Enriched)\n",
    "# \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\n",
    "\n",
...
for cell in nb['cells']:
    if cell['cell_type'] == 'code':
        ...
        # Inject uncertainty functions BEFORE map_optimize_core definition
        if "def map_optimize_core" in source_text and "compute_uncertainties_core" not in source_text:
            cell['source'] = uncertainty_functions + cell['source']
        
        # Update checkpoint loading: add inferred_errors key and handle missing key on load
        ...
        if "def run_inference_pipeline" in source_text and "run_inference_pipeline_alt" not in source_text:
            ...
            # Step-by-step injection for uncertainty computing
            ...
            source_text = source_text.replace("elem_results[:, gi] = core_np[:, ci]",
                                             "elem_results[:, gi] = core_np[:, ci]\n            elem_errors[:, gi]  = core_err_np[:, ci]")
            source_text = source_text.replace("elem_results[:, elem_idx] = e_result.numpy()",
...
print("Notebook patched safely. Original cells preserved.")
