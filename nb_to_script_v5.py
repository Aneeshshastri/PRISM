...
def assemble_perfect_script():
    ...
    # Now, define the Laplace logic string carefully
    # Use triple quotes and avoids expanding the {...} by using {{...}} or joining
    laplace_funcs = r'''
# ============================================================================
...
'''
    ...
    # Inject functions after first few imports
    ...
    # Append inferred_errors in main loop
    ...
    with io.open(out_path, 'w', encoding='utf-8') as f:
        f.write("# FULL REWRITE OF BACKWARD-MODEL PIPELINE (V5 - CLEANEST)\n")
        f.write("# Copy this script into a clean cell in your notebook.\n\n")
        f.write(final_code)

assemble_perfect_script()
print("V5 Integrated script generated.")
